                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="fw-bold text-black-50">Color : <?php echo $color_data["name"] ?></span> &nbsp; |

                                                        &nbsp; <span class="fw-bold text-black-50">Condition : <?php echo $con_data["name"]  ?></span>
                                                        <br>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3 mb-3 d-grid">
                                        <button class="btn btn-primary fs-5 fw-bold" onclick="">CHECKOUT</button>
                                    </div>
