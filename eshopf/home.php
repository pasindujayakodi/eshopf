        ...
        <div class="row">
            ...
            <div class="col-12" id="basicSearchResult">
                <div class="row">
                                        ...
                                        ?>
                                            ...
                                            <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                ...
                                                <div class="card-body ms-0 m-0 text-center">
                                                    ...
                                                    <span class="badge bg-info">New</span><br />
                    ...
                    ?>
                    <!-- msg modal -->
                    <div class="modal" tabindex="-1" id="contactAdmin<?php echo $_SESSION['u']['email'] ?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><?php echo $_SESSION['u']['email'] ?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <?php


                                $recever_email = "sangeethlakshan0@gmail.com";
                                $sender_email = $_SESSION["u"]["email"];
