...
if (isset($_GET["id"])) {
    ...
    product.model_has_brand_id,product.color_id,product.status_id,product.condition_id,product.users_email,
                                                    ...
                                                    <div class="col-12 my-2">
                                                        <div class="row g-2">
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                                                <span class="fs-5 text-primary">Sangeeth</span>
                                                            </div>
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                            ...
                                            <div class="row border border-1 border-dark rounded me-0">
                                                ...
                                                <div class="col-2 mt-1 mb-1 me-0">
                                                    ...
                                                    if($feedback_data["t"] == 1){
                                                        ...
                                                        <?php
                                                    }else if($feedback_data["t"] == 2){
                                                        ?>
                                                        <span class="badge bg-warning">Neutral</span></div>
                                                        <?php
                                                    }else if($feedback_data["t"] == 3){
                                                        ?>
